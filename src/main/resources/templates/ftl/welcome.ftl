...
<html class="x-admin-sm">
    ...
    <body>
    <div class="x-body">
        <blockquote class="layui-elem-quote">欢迎${nickname}！当前时间:${currentTime}  <a onclick="parent.x_admin_add_to_tab('在tab打开','https://www.163.com',true)" style="color: red" href="javascript:;">在tab打开</a>
        </blockquote>
